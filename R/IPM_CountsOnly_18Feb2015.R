...
# call JAGS from R
ObservedHealthStatus.call <- jags.model("ipm.countsonly.bug",
...
save(ObservedHealthStatus.coda, file = "./Data/Posteriors/IPM/ObservedHealthDef/ObservedHealthPostCountsOnly_18Feb2015.RData")
...
# save(Jo.ObservedHealthStatus.coda, file = "./Data/Posteriors/IPM/ObservedHealthDef/Jo.ObservedHealthPost_09Jan2015.RData")
# 
