...
# 
# 
ObservedHealthStatusCollarsOnly.data <- list(
   ewe.surv.pop = ewe.surv.pop,
   ewe.surv.age = ewe.surv.age,
   ewe.surv.year = ewe.surv.year,
   z.adsurv = ewe.surv.status,
...
# call JAGS from R
ObservedHealthStatusCollarsOnly.call <- jags.model("ipm.collarsonly.bug",
                                        data = ObservedHealthStatusCollarsOnly.data,
                                        inits = ipm11.inits,
                                        n.chains = nc,
                                        n.adapt = nb
)

update(ObservedHealthStatusCollarsOnly.call, ni)

ObservedHealthStatusCollarsOnly.coda <- coda.samples(ObservedHealthStatusCollarsOnly.call,
                                          ipm11.params,
                                          ni)
