JohnsonUpdateLeslieFun <- function(current.state, sex.ratio, samples.to.draw, tot.chains, joint.posterior.coda, posterior.names, intro.cost){
  # Johnson age-structure version of UpdateLeslieFun
