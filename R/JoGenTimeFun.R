JoGenTimeFun <- function(current.state, sex.ratio, samples.to.draw, tot.chains, 
                         joint.posterior.coda, posterior.names, intro.cost)
{
  leslie <- JohnsonUpdateLeslieFun(current.state, sex.ratio, samples.to.draw, tot.chains, 
                                   joint.posterior.coda, posterior.names, intro.cost)
